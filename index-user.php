...
<body>
    ...
    <section id="beranda">
        ...
        <div class="container" id="cardContainer">
            <!-- Card 1 -->
            <div class="card" data-name="Kost Nasocha" data-city="Yogyakarta" onclick="window.location.href='detail-nasocha-user.php'">
            ...
            <!-- Card 2 -->
            <div class="card" data-name="Kost Lusi" data-city="Yogyakarta" onclick="window.location.href='detail-lusi-user.php'">
                <div class="image-container">
            ...
            <!-- Card 3 -->
            <div class="card" data-name="Kost Tukijo" data-city="Yogyakarta" onclick="window.location.href='detail-tukijo-user.php'">
                <div class="image-container">
        ...
        <div class="container" id="cardContainer">
            <!-- Card 1 -->
            <div class="card" data-name="Kost Pak Bambang" data-city="Yogyakarta" onclick="window.location.href='detail-pk-bambang-user.php'">
                <div class="image-container">
            ...
            <!-- Card 2 -->
            <div class="card" data-name="Kost Ibu Hadi" data-city="Yogyakarta" onclick="window.location.href='detail-ibu-hadi-user.php'">
                <div class="image-container">
